          ...
          child: Column(
            ...
            children: [
              _SectionCard(
                ...
                bullets: const [
                  'Mengonsumsi data dari API menggunakan Dio di dalam GetX controller.',
                  'Mengelola state loading/error/success dengan variabel `.obs`.',
                  'Memberikan pengalaman pengguna yang konsisten (optimistic UI + snackbar).',
                ],
                color: Colors.blue,
              ),
              ...
              _DetailCard(
                ...
                items: const [
                  ...
                  'Bangun controller dengan RxList dan metode CRUD yang memanggil service.',
                  'Gunakan Obx di UI untuk menampilkan perubahan state (loading/empty/error).',
              ...
              _SectionCard(
                ...
                bullets: const [
                  'Repo publik dengan README (arsitektur singkat + cara menjalankan).',
                  'Screenshot tampilan utama + contoh error state.',
                  'Catatan singkat rencana refactor ke Clean Architecture (Week 8).',
                ],
                color: Colors.orange,
              ),
              const SizedBox(height: 16),
